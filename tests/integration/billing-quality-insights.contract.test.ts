...
describe("billing + extraction contracts", () => {
  it("GET /api/billing/subscription returns dashboard billing fields", async () => {
  ...
  it("POST /api/documents/extract returns a draft expense schema", async () => {
    const app = createMockApp();
